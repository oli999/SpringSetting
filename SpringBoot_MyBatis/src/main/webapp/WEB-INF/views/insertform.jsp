...
<body>
	...
	<%--
		...
		1. webapp/resources/ 에 SmartEditor  폴더를 복사해서 붙여 넣기
		
		2. webapp/resources/ 에 upload 폴더 만들어 두기
		   에디터에서 업로드한 이미지가 자동 저장되는 폴더이다.
		   
		3. 아래 예제 처럼 외부 HuskyEZCreator.js 를 로딩하고 
		   아래 예제에 <script> 내용 </script> 가 있어야 한다. 
		...
		6. 폼을 제출하고 싶으면 반드시  submitContents() 함수가 호출되면서 폼이 제출되어야 한다.  
		   위의 submit 버튼을 보면 이렇게 생겼다
		   <button type="submit" onclick="submitContents(this)">저장</button>
